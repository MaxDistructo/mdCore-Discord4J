...
helpCommandBuilder.append(commands[i] + ": " + commandsObject.getJSONArray(commands[i]).getString("disc") + " Mod Only: " + commandsObject.getJSONArray(commands[i]).getBoolean("moderator") + "\n");
i++;
}
